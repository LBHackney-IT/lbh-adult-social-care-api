...
dotnet restore
dotnet lambda package --configuration release --framework netcoreapp3.1 --output-package ./bin/release/netcoreapp3.1/lbh-adult-social-care-functions-payruns.zip
