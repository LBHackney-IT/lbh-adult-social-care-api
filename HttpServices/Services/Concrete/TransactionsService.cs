    ...
    public class TransactionsService : ITransactionsService
    {
        ...
        public async Task<IEnumerable<DepartmentResponse>> GetPaymentDepartments()
        {
            var httpRequestMessage = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"{_baseUrl}api/v1/departments/payment-departments"),
                Headers =
                {
                    {
            ...
            if (httpResponse.Content == null || httpResponse.Content.Headers.ContentType?.MediaType != "application/json")
                return new HashSet<DepartmentResponse>();
        ...
        private async Task<Guid?> CreateNewPayRun(string payRunName, PayRunForCreationRequest payRunForCreationRequest)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunName}"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<PayRunDateSummaryResponse> GetDateOfLastPayRun(string payRunType)
        {
            ...
            var correctPayRunType =
                allowedPayRunTypes.Find(p => p.Equals(payRunType, StringComparison.OrdinalIgnoreCase));
            ...
            var httpRequestMessage = new HttpRequestMessage
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri(
                    $"{_baseUrl}api/v1/pay-runs/date-of-last-pay-run/{correctPayRunType}"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<PagedPayRunSummaryResponse> GetPayRunSummaryList(PayRunSummaryListParameters parameters)
        {
            ...
            var url = QueryHelpers.AddQueryString($"{_baseUrl}api/v1/pay-runs/summary-list",
                queryParams);
            ...
            SupplierListParameters parameters)
        {
            ...
            var url = QueryHelpers.AddQueryString(
                $"{_baseUrl}api/v1/pay-runs/{payRunId}/unique-suppliers", queryParams);
            ...
            DateTimeOffset? toDate = null)
        {
            ...
            var url = QueryHelpers.AddQueryString($"{_baseUrl}api/v1/pay-runs/released-holds-count",
                queryParams);
        ...
        public async Task<IEnumerable<PackageTypeResponse>> GetUniquePackageTypesInPayRunUseCase(Guid payRunId)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}/unique-package-types"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<IEnumerable<InvoiceStatusResponse>> GetUniquePaymentStatusesInPayRunUseCase(Guid payRunId)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}/unique-payment-statuses"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            DateTimeOffset? toDate = null)
        {
            ...
            var url = QueryHelpers.AddQueryString($"{_baseUrl}api/v1/pay-runs/released-holds",
                queryParams);
            ...
            InvoiceListParameters parameters)
        {
            ...
            var url = QueryHelpers.AddQueryString($"{_baseUrl}api/v1/pay-runs/{payRunId}/details",
                queryParams);
        ...
        public async Task<PayRunInsightsResponse> GetSinglePayRunInsightsUseCase(Guid payRunId)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}/summary-insights"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> SubmitPayRunForApprovalUseCase(Guid payRunId)
        {
            var httpRequestMessage = new HttpRequestMessage
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri(
                    $"{_baseUrl}api/v1/pay-runs/{payRunId}/status/submit-for-approval"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> KickBackPayRunToDraftUseCase(Guid payRunId)
        {
            var httpRequestMessage = new HttpRequestMessage
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri(
                    $"{_baseUrl}api/v1/pay-runs/{payRunId}/status/kick-back-to-draft"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> ApprovePayRunForPaymentUseCase(Guid payRunId)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}/status/approve-pay-run"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            ReleaseHeldInvoiceItemRequest releaseHeldInvoiceItemRequest)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/release-held-invoice"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            IEnumerable<ReleaseHeldInvoiceItemRequest> releaseHeldInvoiceItemRequests)
        {
            ...
            {
                Method = HttpMethod.Put,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/release-held-invoice-list"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> DeleteDraftPayRunUseCase(Guid payRunId)
        {
            var httpRequestMessage = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<IEnumerable<InvoiceStatusResponse>> GetAllInvoiceStatusesUseCase()
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/invoices/invoice-status-list"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<IEnumerable<InvoiceStatusResponse>> GetInvoicePaymentStatusesUseCase()
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/invoices/invoice-payment-statuses"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> AcceptInvoiceUseCase(Guid payRunId, Guid invoiceId)
        {
            var httpRequestMessage = new HttpRequestMessage
            {
                Method = HttpMethod.Put,
                RequestUri = new Uri(
                    $"{_baseUrl}api/v1/pay-runs/{payRunId}/invoices/{invoiceId}/accept-invoice"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<BillResponse> CreateSupplierBillUseCase(BillCreationRequest billCreationRequest)
        {
            ...
            {
                Method = HttpMethod.Post,
                RequestUri = new Uri($"{_baseUrl}api/v1/bills"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> PaySupplierBillUseCase(IEnumerable<long> supplierBillIds)
        {
            ...
            {
                Method = HttpMethod.Post,
                RequestUri = new Uri($"{_baseUrl}api/v1/bills/pay"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<PagedBillSummaryResponse> GetBillSummaryList(BillSummaryListParameters parameters)
        {
            ...
            var url = QueryHelpers.AddQueryString($"{_baseUrl}api/v1/bills", queryParams);
        ...
        public async Task<IEnumerable<SupplierTaxRateResponse>> GetSupplierTaxRateUseCase(long supplierId)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/suppliers/{supplierId}/tax-rates"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<bool> AcceptInvoicesUseCase(Guid payRunId, InvoiceIdListRequest invoiceIdList)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage
            {
                Method = HttpMethod.Put,
                RequestUri =
                    new Uri($"{_baseUrl}api/v1/pay-runs/{payRunId}/invoices/accept-invoices"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
        ...
        public async Task<IEnumerable<PayRunTypeResponse>> GetAllPayRunTypesUseCase()
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/pay-run-types"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            if (httpResponse.Content == null || httpResponse.Content.Headers.ContentType?.MediaType != "application/json")
                return new List<PayRunTypeResponse>();
        ...
        public async Task<IEnumerable<PayRunSubTypeResponse>> GetAllPayRunSubTypesUseCase()
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/pay-run-sub-types"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            if (httpResponse.Content == null || httpResponse.Content.Headers.ContentType?.MediaType != "application/json")
                return new List<PayRunSubTypeResponse>();
        ...
        public async Task<IEnumerable<PayRunStatusResponse>> GetAllUniquePayRunStatusesUseCase()
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"{_baseUrl}api/v1/pay-runs/unique-pay-run-statuses"),
                Headers =
                {
                    {
                        HttpRequestHeader.Accept.ToString(), "application/json"
            ...
            if (httpResponse.Content == null || httpResponse.Content.Headers.ContentType?.MediaType != "application/json")
                return new List<PayRunStatusResponse>();
