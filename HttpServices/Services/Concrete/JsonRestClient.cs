...
namespace HttpServices.Services.Concrete
{
    ...
    public class JsonRestClient : IRestClient
    {
        ...
        /// </summary>
        public async Task<TResult> Get<TResult>(string url, string errorMessage) where TResult : class
        {
        ...
        /// </summary>
        public async Task<TResult> Post<TResult>(string url, object payload, string errorMessage) where TResult : class
        {
        ...
        /// </summary>
        public async Task<TResult> Put<TResult>(string url, object payload, string errorMessage) where TResult : class
        {
            return await SubmitRequest<TResult>(url, payload, errorMessage, HttpMethod.Put).ConfigureAwait(false);
        }

        private async Task<TResult> SubmitRequest<TResult>(string url, object payload, string errorMessage, HttpMethod method) where TResult : class
        {
