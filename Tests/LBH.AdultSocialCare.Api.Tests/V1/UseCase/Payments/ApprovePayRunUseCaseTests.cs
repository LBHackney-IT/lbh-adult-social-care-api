...
namespace LBH.AdultSocialCare.Api.Tests.V1.UseCase.Payments
{
    public class ApprovePayRunUseCaseTests : BaseInMemoryDatabaseTest
    {
        ...
        [Fact]
        private async void ShouldApprovePayRun()
        {
        ...
        [Fact]
        private void ShouldRaiseExceptionIfPayRunDoesNotExist()
        {
            _payRunGateway.Setup(g => g.GetPayRunAsync(It.IsAny<Guid>(), It.IsAny<PayRunFields>(), It.IsAny<bool>()))
        ...
        [Fact]
        private void ShouldFailIfAnyInvoiceIsStillInDraft()
        {
        ...
        private void ShouldFailIfPayrunNotInReviewOrWaitingForApproval(PayrunStatus status)
        {
