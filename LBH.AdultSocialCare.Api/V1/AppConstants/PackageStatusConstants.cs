namespace LBH.AdultSocialCare.Api.V1.AppConstants
{
    public static class PackageStatusConstants
    {
        ...
        public const string BrokeredDealApproved = "Commercials Approved";
        public const int BrokeredDealApprovedId = 12;
        public const string BrokeredDealRejected = "Package Commercials - Rejected";
        public const int BrokeredDealRejectedId = 13;
        public const string BrokeredDealRequestMoreInformation = "Clarifying Commercials";
